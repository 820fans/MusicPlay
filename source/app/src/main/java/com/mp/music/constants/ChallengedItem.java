...
public class ChallengedItem {
    ...
    public ChallengedItem(int id, String avatar, String challenge_name, String upper_name, String upper_time){
        this.id=id;
        this.avatar=avatar;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ChallengedItem) {
            ChallengedItem p = (ChallengedItem) obj;
            return this.id==p.id;
        }
