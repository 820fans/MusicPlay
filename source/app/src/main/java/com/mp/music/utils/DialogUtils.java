...
public class DialogUtils {
	...
	public static AlertDialog showConfirmDialog(Context context, String title,
			String msg,String confirm,String cancel, OnClickListener confirmListener,OnClickListener cancelListener) {
		...
		AlertDialog dialog=builder
				...
				.setPositiveButton(confirm, confirmListener).show();
