 ...
 */
public class ChallengedListAdapter extends  RecyclerView.Adapter<ChallengedListAdapter.ViewHolder>{
    ...
    private ArrayList<ChallengedItem> mDatas;

    public ChallengedListAdapter(Context context, ArrayList<ChallengedItem> datats)
    {
    ...
    {
        View view = mInflater.inflate(R.layout.item_challenged,
                viewGroup, false);
